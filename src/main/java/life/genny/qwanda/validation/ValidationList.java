...
/**
 * ValidationList represents a set of Validations the Qwanda library.
 * The validations in the list can be applied to a passed value.
 * <ul>
...
public class ValidationList implements Serializable {
	...
	*/
	...
	public ValidationList(List<Validation> validations) 
	{
