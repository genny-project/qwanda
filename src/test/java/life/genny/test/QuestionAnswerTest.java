...
public class QuestionAnswerTest {
	...
	public void setup() throws BadDataException {
		...
		try {
			...
			attributeBrackets = new AttributeText(AttributeText.getDefaultCodePrefix() + "BRACKETS_TEST", "Brackets");

			attributeFirstname = new AttributeText(AttributeText.getDefaultCodePrefix() + "FIRSTNAME_TEST",
					"Firstname");
			attributeLastname = new AttributeText(AttributeText.getDefaultCodePrefix() + "LASTNAME_TEST", "Surname");
			attributeBirthdate = new AttributeDateTime(AttributeText.getDefaultCodePrefix() + "BIRTHDAY",
					"Date of Birth");
			
			session.save(attributeBrackets);
			session.save(attributeFirstname);
			session.save(attributeLastname);
			session.save(attributeBirthdate);
...
//
	...
	public void entityAttributeTest() {
		...
		try {
			...
			questionBrackets = new Question(Question.getDefaultCodePrefix() + "BRACKETS", "(?)", attributeBrackets);
	...
	public void questionQuestionTest() {
		...
		try {
			...
			AttributeText attributeFirstname2 = new AttributeText(
					AttributeText.getDefaultCodePrefix() + "FIRSTNAME_TEST2", "Firstname");
			AttributeText attributeLastname2 = new AttributeText(
					AttributeText.getDefaultCodePrefix() + "LASTNAME_TEST2", "Surname");
			AttributeDate attributeBirthdate2 = new AttributeDate(AttributeText.getDefaultCodePrefix() + "BIRTHDAY2",
					"Date of Birth");
			AttributeText attributeMiddlename2 = new AttributeText(
					AttributeText.getDefaultCodePrefix() + "MIDDLENAME_TEST2", "Middle Name");
			...
			Question questionLastname2 = new Question(Question.getDefaultCodePrefix() + "LASTNAME2", "Lastname:",
					attributeLastname2);
			Question questionBirthdate2 = new Question(Question.getDefaultCodePrefix() + "BIRTHDATE2", "Birthdatee:",
					attributeBirthdate2);
