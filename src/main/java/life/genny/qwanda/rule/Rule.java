...
/**
 * Rule represents a distinct abstract Rule
 * managed in the Qwanda library.
 * An rule may be used directly in processing meaning for an event
 * using inference and induction  This
...
public class Rule extends CodedEntity implements Serializable {
	...
	private static final String DEFAULT_CODE_PREFIX = "RUL_";
...
// assume valid rule
	public Rule(String aCode, String aName, String rule)
	{
		super(aCode, aName);
		setRule(rule);
	}
