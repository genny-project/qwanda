...
//   person.addAnswer(answerBirthdate, 1.0);
   ...
   final Answer answer = new Answer("PER_ADAMTEST","PER_ADAMTEST","PRI_FIRSTNAME","Adam");
   final Answer answer2 = new Answer("PER_BYRONTEST","PER_BYRONTEST","PRI_FIRSTNAME","Byron");
