...
/**
 * Ask represents the presentation of a Question to a source entity.
 * A Question object is refered to as a means of requesting information
 * from a source about a target attribute.  This
 * ask information includes:
 * <ul>
 ...
 * from sources.
 * Each ask is associated with an question which represents one or more distinct
 * fact about a target.
 * <p>
 * 
 * 
...
//	@JsonInclude(Include.NON_NULL)
	...
	/**
	  ...
	  */
	public Ask(Question aQuestion,BaseEntity aSource, BaseEntity aTarget)
	{
		super(aQuestion.getName());
		this.question = aQuestion;
		this.source = aSource;
	...
	public void add(Answer answer) throws BadDataException {
		if ((answer.getSourceCode().equals(source.getCode()) )&&(answer.getTargetCode().equals(target.getCode()) )) {
