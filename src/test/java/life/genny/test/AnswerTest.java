...
public class AnswerTest {
    ...
    public void AnswerDatetest() {
        ...
        AnswerLink link = new AnswerLink();
        Answer dateTime = new Answer("PER_USER1","BEG_JOMU655BE9F30EAD431F8BF7DC5627B86705", "PRI_PICKUP_DATETIME", "2018-01-16");
        dateTime.setId(new Long(20));
        dateTime.setAskId(new Long(10));
        System.out.println("Answer   ::  "+dateTime.toString());
        ...
        attributeDate = new AttributeDate("PRI_PICKUP_DATE","Test DateTiume 7");
         link = new AnswerLink();
        dateTime = new Answer("PER_USER1","BEG_JOMU655BE9F30EAD431F8BF7DC5627B86705", "PRI_PICKUP_DATETIME", "2018-01-16T00:00:00");
        dateTime.setId(new Long(20));
        dateTime.setAskId(new Long(10));
        System.out.println("Answer   ::  "+dateTime.toString());
        link.setAttribute(attributeDate);
